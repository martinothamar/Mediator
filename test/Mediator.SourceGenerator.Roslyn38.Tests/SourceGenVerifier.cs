    ...
    where TSourceGenerator : ISourceGenerator, new()
{
    public class Test : CSharpSourceGeneratorTest<TSourceGenerator, XUnitVerifier>
    {
        public Test()
        {
            ...
            this.SolutionTransforms.Add((sln, projectId) =>
            {
                var compilationOptions = ((CSharpCompilationOptions)sln.GetProject(projectId)!.CompilationOptions!)
                    .WithOutputKind(OutputKind.ConsoleApplication)
                    .WithUsings("System", "System.Collections.Generic", "System.IO", "System.Linq", "System.Net.Http", "System.Threading", "System.Threading.Tasks");

                sln = sln
                    .AddMetadataReferences(projectId, metadataRefs)
