...
namespace SimpleConsole.Mediator.Internals
{
    ...
    internal interface IMessageHandlerBase
    {
        global::System.Threading.Tasks.ValueTask<object?> Handle(
            global::SimpleConsole.Mediator.Mediator mediator,
            object request,
    ...
    {
        private global::SimpleConsole.Mediator.Mediator _mediator = null!;

        public UnitRequestHandlerWrapper<TRequest> Init(global::SimpleConsole.Mediator.Mediator mediator)
        {
            _mediator = mediator;
            return this;
        }
        ...
        where TRequest : global::Mediator.IRequest
    {
        ...
        {
            var concreteHandler = mediator.Services.GetRequiredService<global::SimpleConsole.Mediator.Internals.UnitRequestHandlerWrapper<TRequest>>();
    ...
    internal class UnitCommandHandlerWrapper<TRequest> where TRequest : global::Mediator.ICommand
    {
        ...
        public UnitCommandHandlerWrapper<TRequest> Init(global::SimpleConsole.Mediator.Mediator mediator)
        {
            _mediator = mediator;
            return this;
        }
        ...
        where TRequest : global::Mediator.ICommand
    {
        ...
        {
            var concreteHandler = mediator.Services.GetRequiredService<global::SimpleConsole.Mediator.Internals.UnitCommandHandlerWrapper<TRequest>>();
            concreteHandler.Init(mediator);
            var pipelineBehaviours = mediator.Services.GetServices<global::Mediator.IPipelineBehavior<TRequest, global::Mediator.Unit>>();
            var handler = (global::Mediator.MessageHandlerDelegate<TRequest, global::Mediator.Unit>)concreteHandler.Handle;
