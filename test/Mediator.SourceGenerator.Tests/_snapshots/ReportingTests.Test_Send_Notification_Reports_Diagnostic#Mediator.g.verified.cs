...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class MediatorDependencyInjectionExtensions
    {
        ...
        public static IServiceCollection AddMediator(this IServiceCollection services, global::System.Action<global::Mediator.MediatorOptions>? options)
        {
            ...
            services.Add(new global::Microsoft.Extensions.DependencyInjection.ServiceDescriptor(typeof(global::Mediator.Internals.NotificationHandlerWrapper<global::TestCode.UserCreated>), typeof(global::Mediator.Internals.NotificationHandlerWrapper<global::TestCode.UserCreated>), global::Microsoft.Extensions.DependencyInjection.ServiceLifetime.Singleton));

            // Register notification handlers
            services.TryAdd(new global::Microsoft.Extensions.DependencyInjection.ServiceDescriptor(typeof(global::TestCode.UserCreatedHandler), typeof(global::TestCode.UserCreatedHandler), global::Microsoft.Extensions.DependencyInjection.ServiceLifetime.Singleton));
            services.Add(new global::Microsoft.Extensions.DependencyInjection.ServiceDescriptor(typeof(global::Mediator.INotificationHandler<global::TestCode.UserCreated>), GetRequiredService<global::TestCode.UserCreatedHandler>(), global::Microsoft.Extensions.DependencyInjection.ServiceLifetime.Singleton));
...
namespace Mediator.Internals
{
    ...
    internal sealed class ContainerMetadata
    {
        ...
        public readonly global::Mediator.Internals.NotificationHandlerWrapper<global::TestCode.UserCreated> Wrapper_For_TestCode_UserCreated;
        ...
        public ContainerMetadata(global::System.IServiceProvider sp)
        {
            ...
            notificationHandlerTypes.Add(typeof(global::TestCode.UserCreated), sp.GetRequiredService<global::Mediator.Internals.NotificationHandlerWrapper<global::TestCode.UserCreated>>().Init(this, sp));
            ...
            Wrapper_For_TestCode_UserCreated = sp.GetRequiredService<global::Mediator.Internals.NotificationHandlerWrapper<global::TestCode.UserCreated>>().Init(this, sp);
        }
    }
}
...
namespace Mediator
{
    ...
    public sealed partial class Mediator : global::Mediator.IMediator, global::Mediator.ISender, global::Mediator.IPublisher
    {
        ...
        )
        {
            switch (notification)
            {
                case global::TestCode.UserCreated n: return Publish(n, cancellationToken);
                default:
                {
        ...
        /// <summary>
        /// Send a notification of type global::TestCode.UserCreated.
        /// Throws <see cref="global::System.ArgumentNullException"/> if message is null.
        /// Throws <see cref="global::System.AggregateException"/> if handlers throw exception(s).
        /// </summary>
        ...
        /// <returns>Awaitable task</returns>
        public global::System.Threading.Tasks.ValueTask Publish(
            global::TestCode.UserCreated notification,
            global::System.Threading.CancellationToken cancellationToken = default
        )
        {
            ThrowIfNull(notification, nameof(notification));

            return _containerMetadata.Value.Wrapper_For_TestCode_UserCreated.Handle(notification, cancellationToken);
        }
