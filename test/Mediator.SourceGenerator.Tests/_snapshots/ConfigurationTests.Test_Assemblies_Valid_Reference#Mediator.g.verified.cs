...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class MediatorDependencyInjectionExtensions
    {
        ...
        public static IServiceCollection AddMediator(this IServiceCollection services, global::System.Action<global::Mediator.MediatorOptions>? options)
        {
            ...
            services.TryAdd(new SD(typeof(global::TestCode.Request0Handler), typeof(global::TestCode.Request0Handler), global::Microsoft.Extensions.DependencyInjection.ServiceLifetime.Singleton));
            services.Add(new SD(typeof(global::Mediator.IRequestHandler<global::TestCode.Request0, global::TestCode.Response0>), typeof(global::TestCode.Request0Handler), global::Microsoft.Extensions.DependencyInjection.ServiceLifetime.Singleton));
            services.Add(new SD(typeof(global::Mediator.Internals.RequestHandlerWrapper<global::TestCode.Request0, global::TestCode.Response0>), typeof(global::Mediator.Internals.RequestHandlerWrapper<global::TestCode.Request0, global::TestCode.Response0>), global::Microsoft.Extensions.DependencyInjection.ServiceLifetime.Singleton));
            services.TryAdd(new SD(typeof(global::TestCode.Library1.Request1Handler), typeof(global::TestCode.Library1.Request1Handler), global::Microsoft.Extensions.DependencyInjection.ServiceLifetime.Singleton));
            services.Add(new SD(typeof(global::Mediator.IRequestHandler<global::TestCode.Library1.Request1, global::TestCode.Library1.Response1>), typeof(global::TestCode.Library1.Request1Handler), global::Microsoft.Extensions.DependencyInjection.ServiceLifetime.Singleton));
...
namespace Mediator.Internals
{
    ...
    internal sealed class ContainerMetadata
    {
        ...
        public readonly global::Mediator.Internals.RequestHandlerWrapper<global::TestCode.Request0, global::TestCode.Response0> Wrapper_For_TestCode_Request0;
        public readonly global::Mediator.Internals.RequestHandlerWrapper<global::TestCode.Library1.Request1, global::TestCode.Library1.Response1> Wrapper_For_TestCode_Library1_Request1;
        ...
        public ContainerMetadata(global::System.IServiceProvider sp)
        {
            ...
            requestHandlerTypes.Add(typeof(global::TestCode.Request0), sp.GetRequiredService<global::Mediator.Internals.RequestHandlerWrapper<global::TestCode.Request0, global::TestCode.Response0>>().Init(this, sp));
            requestHandlerTypes.Add(typeof(global::TestCode.Library1.Request1), sp.GetRequiredService<global::Mediator.Internals.RequestHandlerWrapper<global::TestCode.Library1.Request1, global::TestCode.Library1.Response1>>().Init(this, sp));
            ...
            Wrapper_For_TestCode_Request0 = sp.GetRequiredService<global::Mediator.Internals.RequestHandlerWrapper<global::TestCode.Request0, global::TestCode.Response0>>().Init(this, sp);
            Wrapper_For_TestCode_Library1_Request1 = sp.GetRequiredService<global::Mediator.Internals.RequestHandlerWrapper<global::TestCode.Library1.Request1, global::TestCode.Library1.Response1>>().Init(this, sp);
        }
    }
}
...
namespace Mediator
{
    ...
    public sealed partial class Mediator : global::Mediator.IMediator, global::Mediator.ISender, global::Mediator.IPublisher
    {
        ...
        /// <summary>
        /// Send a request of type global::TestCode.Request0.
        /// </summary>
        /// <param name="request">Incoming request</param>
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>Awaitable task</returns>
        public global::System.Threading.Tasks.ValueTask<global::TestCode.Response0> Send(
            global::TestCode.Request0 request,
            global::System.Threading.CancellationToken cancellationToken = default
        )
        {
            return _containerMetadata.Value.Wrapper_For_TestCode_Request0.Handle(request, cancellationToken);
        }

        /// <summary>
        /// Send a request of type global::TestCode.Library1.Request1.
        /// </summary>
        /// <param name="request">Incoming request</param>
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>Awaitable task</returns>
        public global::System.Threading.Tasks.ValueTask<global::TestCode.Library1.Response1> Send(
            global::TestCode.Library1.Request1 request,
            global::System.Threading.CancellationToken cancellationToken = default
        )
        {
            return _containerMetadata.Value.Wrapper_For_TestCode_Library1_Request1.Handle(request, cancellationToken);
        }
        ...
        )
        {
            switch (request)
            {
                case global::TestCode.Request0 r:
                {
                    if (typeof(TResponse) == typeof(global::TestCode.Response0))
                    {
                        var task = Send(r, cancellationToken);
                        return global::System.Runtime.CompilerServices.Unsafe.As<global::System.Threading.Tasks.ValueTask<global::TestCode.Response0>, global::System.Threading.Tasks.ValueTask<TResponse>>(ref task);
                    }
                    return SendAsync(request, cancellationToken);
                }
                case global::TestCode.Library1.Request1 r:
                {
                    if (typeof(TResponse) == typeof(global::TestCode.Library1.Response1))
                    {
                        var task = Send(r, cancellationToken);
                        return global::System.Runtime.CompilerServices.Unsafe.As<global::System.Threading.Tasks.ValueTask<global::TestCode.Library1.Response1>, global::System.Threading.Tasks.ValueTask<TResponse>>(ref task);
                    }
                    return SendAsync(request, cancellationToken);
                }
                default:
        ...
        )
        {
            switch (request)
            {
                case global::TestCode.Request0 r:
                {
                    ...
                    return global::System.Runtime.CompilerServices.Unsafe.As<global::TestCode.Response0, TResponse>(ref response);
                }
                case global::TestCode.Library1.Request1 r:
                {
                    var response = await Send(r, cancellationToken);
                    return global::System.Runtime.CompilerServices.Unsafe.As<global::TestCode.Library1.Response1, TResponse>(ref response);
                }
                default:
                {
                    ThrowInvalidRequest(request, nameof(request));
        ...
        )
        {
            switch (message)
            {
                case global::Mediator.IBaseRequest request:
                    switch (request)
                    {
                        case global::TestCode.Request0 r: return await Send(r, cancellationToken);
                        case global::TestCode.Library1.Request1 r: return await Send(r, cancellationToken);
                        default:
                        {
                            ThrowInvalidRequest(request, nameof(request));
                            return default;
